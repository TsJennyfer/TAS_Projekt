...
$scope.readOneProduct = function(id){
    ...
    productsFactory.readOneProduct(id).then(function successCallback(response){
        ...
        $scope.Tytul = response.data.Tytul;
        $scope.Autor = response.data.Autor;
        $scope.RokWydania = response.data.RokWydania;
		$scope.Gatunek = response.data.Gatunek;
		$scope.Opis = response.data.Opis;
		$scope.Cena = response.data.Cena;
		$scope.Promocja = response.data.Promocja;
		$scope.Okladka = response.data.Okladka;
